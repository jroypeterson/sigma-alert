...
7. **Every digest**: a **Sector Index Returns** section at the bottom shows the day's performance of the sector ETFs (XLV, XLK, XLE, etc.) with their own z-scores and 52-week ranges. Reuses already-downloaded data — no extra network calls
...
| Sector ETFs | `sources/sector_etfs.txt` | SPDR Select Sector ETFs + SPYM S&P 500 portfolio ETF. These drive both the alert checks and the "Sector Index Returns" section at the bottom of every digest |
