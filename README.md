...
| Global equity ETFs | `sources/global_equity_etfs.txt` | Global/international equity index ETFs (ACWI, EFA, EEM, VGK, EWJ, EWY, FXI, INDA). Render under `_Global Equity_` directly below the US `_Indices_` group. Country ETFs are USD-denominated (bundle local-equity + FX) |
